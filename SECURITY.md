...
Report security vulnerabilities using [GitHub Security Advisories](https://github.com/malpanez/hetzner-secure-infrastructure/security/advisories/new).
...
- SSH management access is locked to a single source IP (a VPN/bastion is an optional future addition)
...
- **Trivy**: Filesystem and infrastructure vulnerability scanning
- **tfsec**: Terraform/OpenTofu security scanning
...
- Follow [@malpanez](https://github.com/malpanez) for announcements
