...
- [x] **Phase 3.6: Security Hardening** (INSERTED) - Resolve all audit findings C1-C4, H1-H4, M1-M3: SSH config, UFW, monitoring ports, AppArmor, PHP hardening, fail2ban, file permissions, repo/server gaps (completed 2026-04-20)
