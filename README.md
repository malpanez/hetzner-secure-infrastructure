...
| `nginx_wordpress` | Hardened nginx + PHP-FPM + WordPress: FastCGI cache, Cloudflare real-IP, rate limiting, pluggable mu-plugins, optional object-storage media proxy, multi-site capable |
